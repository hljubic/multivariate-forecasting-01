...
class STAR(nn.Module):
    def __init__(self, d_series, d_core, dropout_rate=0.5, max_len=5000):
        ...
        """
        STAR model with Dynamic Routing Attention
        """
        ...
        self.routing = nn.Linear(d_core, 1)  # Routing weights
    ...
    def forward(self, input, *args, **kwargs):
        ...
        # Dynamic Routing Attention (adjusts attention based on learned importance)
        ...
        # Apply dynamic routing: calculate routing weights and adjust attention scores
        routing_weights = self.routing(values).squeeze(-1)
        attention_scores = attention_scores * routing_weights.unsqueeze(-1)
